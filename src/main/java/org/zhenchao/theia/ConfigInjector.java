...
import org.zhenchao.theia.anno.TestingVisible;
import org.zhenchao.theia.constant.Constants;
import org.zhenchao.theia.error.ConfigException;
import org.zhenchao.theia.inject.PropertyInjector;
import org.zhenchao.theia.inject.PropertyInjectorDetector;
import org.zhenchao.theia.listener.InjectEventListener;
import org.zhenchao.theia.listener.UpdateEventListener;
import org.zhenchao.theia.source.PropertiesBuilderFactory;
import org.zhenchao.theia.source.Source;
import org.zhenchao.theia.source.provider.ProviderFactory;
import org.zhenchao.theia.source.provider.SourceProvider;
...
public class ConfigInjector implements AutoCloseable {
    ...
    public synchronized void close() {
        ...
        log.info("Shutdown theia config injector.");
