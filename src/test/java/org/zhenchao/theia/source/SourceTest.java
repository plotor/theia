 ...
 */
package org.zhenchao.theia.source;
...
import org.zhenchao.theia.BaseTestCase;
import org.zhenchao.theia.ConfigInjector;
import org.zhenchao.theia.Configurable;
import org.zhenchao.theia.Options;

@Configurable("ZK:/theia/example")
public class SourceTest extends BaseTestCase implements Options {
    ...
    public void testHashCode() {
        ...
        Source s3 = new Source(this.getClass(), "ZK:/theia/example");
    ...
    public void testConfigurableSourceObject() {
        ...
        assertEquals("ZK:/theia/example", s2.getResourceName());
    }

    @Test
    public void testSource() throws Exception {
        Source source = new Source(this.getClass(), "ZK:/theia/example");
        assertSame(this.getClass(), source.getOptionsClass());
        assertEquals("ZK:/theia/example", source.getResourceName());
    }
    ...
    @Configurable(resource = "ZK:/theia/example")
